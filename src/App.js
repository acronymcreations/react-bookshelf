        ...
        <Route exact path="/" render={() => (
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Book list={book_list} shelf='currentlyReading' shelf_name='Currently Reading'/>
                <Book list={book_list} shelf='wantToRead' shelf_name='Want to Read'/>
                <Book list={book_list} shelf='read' shelf_name='Read'/>
              </div>
            </div>
